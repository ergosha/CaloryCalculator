...
export default function App() {
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput
      style = {styles.input}
      onChangeText={text => setWeight(text)} // onChangeText={(text) => setWeight(text)}
      ...
      onValueChange={(itemValue) => setIntensity(itemValue)} //onValueChange={(itemValue) => setIntensity(itemValue)}
